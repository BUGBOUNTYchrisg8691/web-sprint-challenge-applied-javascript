...
Document Object Model - The tree in which the body of the html is built, what JS uses to access the HTML elements

2. What is an event?

something the browser or user does that occur to HTML element and JS can react to those occurence to trigger functions

3. What is an event listener?

an object that is preset to do something when a certain event occurs, it handles an event to do a predetermined set of actions when the event fires

4. Why would we convert a NodeList into an Array?

so you can manipulate the elements inside of it and access them by index
